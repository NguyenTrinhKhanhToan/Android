package com.example.NguyenTrinhKhanhToan;
...
public class KhanhToan_56th2 extends Activity {
 ListView lv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main_khanh_toan_56th2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.khanh_toan_56th2, menu);
        return true;
    }
